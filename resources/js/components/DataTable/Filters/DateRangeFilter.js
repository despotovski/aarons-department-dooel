...
function DateRangeFilter ({
  ...
  const { labels, placeholder } = filterSettings ?? {}
    ...
    <>
      <div className='col-md-4'>
        <div className='input-element input-text'>
          <label>{labels && labels.startDate ? labels.startDate : t('ui.from')}</label>
      ...
      <div className='col-md-4'>
        <div className='input-element input-text'>
          <label htmlFor='global-search'>{labels && labels.endDate ? labels.endDate : t('ui.to')}</label>
          <div className='input-container'>
            <DatePicker
              locale={i18n.language}
              selected={endDate}
