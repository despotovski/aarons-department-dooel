...
const IconHeartOutline = ({ className }) => {
  return (
    <svg className={`svg-inline ${className || ''}`} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 17'>
      <path d='M9.5,1.6L10,2.1l0.5-0.5c1.3-1.3,3.1-1.8,4.9-1.5C18,0.5,20,2.8,20,5.6v0.2c0,1.6-0.7,3.2-1.9,4.3l-7.1,6.5
